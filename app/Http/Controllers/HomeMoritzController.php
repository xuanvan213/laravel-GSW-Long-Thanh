...
class HomeMoritzController extends Controller
{
    /**
    ...
    {
        return view('moritz.index-moritz');
    }
    ...
    public function destroy($id)
    {
     ...
     public static function sendEmailSubcribes(Request $request )
     {
         ...
         Mail::send('emails.mailSubcribesMoritz', $data, function ($message) {
     ...
     public static function sendEmailContacts(Request $request )
     {
         ...
         Mail::send('emails.mailContactMoritz', $data, function ($message) {
     ...
     public function sitemap(){
        return response()->view('sitemap.sitemap-moritz')->header('Content-Type', 'text/xml');
    }
}
