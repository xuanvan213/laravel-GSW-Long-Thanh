...
<meta charset="utf-8">
  ...
  <meta name="keywords" content="Opal Garden, du an Opal Garden, bất động sản Thủ Đức, căn hộ view sông, căn hộ Opal Garden, dự án căn hộ chung cư, căn hộ gần Gigamall, căn hộ Thủ Đức view sông, cuộc sống xanh, căn hộ vị trí đắc địa Opal Garden, du an Opal Garden, bất động sản Thủ Đức, căn hộ view sông, căn hộ Opal Garden, dự án căn hộ chung cư, căn hộ gần Gigamall, căn hộ Thủ Đức view sông, cuộc sống xanh, căn hộ vị trí đắc địa ">
  ...
  <meta property="og:title" content="DỰ ÁN Opal Garden" /> 
  <meta property="og:type" content="article" /> 
  <meta property="og:url" content="" /> 
  <meta property="og:image" content="/images/logo-opal-garden.png" /> 
  <meta property="og:description" content="Opal Garden nằm mặt tiền đường số 20, Ngay bên cạnh trung tâm thương mại GigaMall đường Đường Phạm Văn Đồng chỉ cách cầu Bình Triệu (Cầu Bình Lợi) quận Bình Thạnh 500m. Dự án chung cư đã bàn giao nhà là một trong số hiếm hoi căn hộ cao cấp quận thủ đức. Chuỗi căn hộ Opal Garden, Opal Riverside đường số 23, Opal Boulevard nút giao Phạm Văn Đồng và Tô Ngọc Vân, St Moritz Phạm Văn Đồng khẳng định Đất Xanh là thương hiệu uy tín cho khách hàng đặt niềm tin." /> 
  <meta property="og:site_name" content="DỰ ÁN OPAL GARDEN" />
  <meta property="og:image:url" content="/images/logo-opal-garden.png">
  ...
  <meta name="twitter:description" content="Opal Garden nằm mặt tiền đường số 20, Ngay bên cạnh trung tâm thương mại GigaMall đường Đường Phạm Văn Đồng chỉ cách cầu Bình Triệu (Cầu Bình Lợi) quận Bình Thạnh 500m. Dự án chung cư đã bàn giao nhà là một trong số hiếm hoi căn hộ cao cấp quận thủ đức. Chuỗi căn hộ Opal Garden, Opal Riverside đường số 23, Opal Boulevard nút giao Phạm Văn Đồng và Tô Ngọc Vân, St Moritz Phạm Văn Đồng khẳng định Đất Xanh là thương hiệu uy tín cho khách hàng đặt niềm tin.">
  <meta name="twitter:image" content="/images/logo-opal-garden.png">
  <meta name="twitter:card" content="summary_large_image">

  <!-- Favicons -->
  <link rel="shortcut icon" sizes="196x196" href="/images/logo-opal-garden.png">
  <link rel="apple-touch-icon" href="/images/logo-opal-garden.png">
  <link rel="apple-touch-icon" sizes="72x72" href="/images/logo-opal-garden.png">
  <link rel="apple-touch-icon" sizes="114x114" href="/images/logo-opal-garden.png">

  <title>DỰ ÁN OPAL GARDEN</title> 
  ...
  {{-- Google review --}}
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [{
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Giá bán dự án Opal Garden đang được truyền thông với: căn hộ giá dự kiến từ 1865$/m2"
        }
      }, {
        "@type": "Question",
        "name": "Thời gian mở bán Opal Garden?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  <div class="wrapper boxed">
    ...
    <div class="menu"> 
      ...
      <nav class="nav mobile-menu">
        ...
        <li>
            <a  href="#du-an-opal-garden">Trang Chủ</a>
          </li>
          <li>
            <a href="#gioi-thieu-du-an-opal-garden">Giới Thiệu</a>
          </li>
          <li>
            <a href="#tien-ich-du-an-opal-garden">Tiện Ích</a>
          </li>
          <li>
            <a href="#thu-vien-du-an-opal-garden">Thư Viện</a>
          </li>
          <li>
            <a href="#can-ho-mau-du-an-opal-garden">Căn Hộ Mẫu</a>
          </li>
          <li>
            <a href="#thiet-ke-can-ho-du-an-opal-garden">Thiết Kế Căn Hộ</a>
          </li>
          <li>
            <a href="#lien-he-du-an-opal-garden">Liên Hệ</a>
          </li>
        </ul>
      </nav>
    </div>
    ...
    <header class="navbar boxed js-navbar">
      ...
      <!-- Brand -->
      <a class="brand" href="#">
        <img src="/images/logo-opal-garden.png" alt="hình ảnh dự án Opal Garden">
        <div class="brand-info">
          <div class="brand-name">Opal Garden</div>
      ...
      <div class="footer-flex">
        <div class="flex-item">
          <a class="brand pull-left" href="anzbds.com">
            <img alt="hình ảnh dự án Opal Garden" src="/images/logo-opal-garden.png">
            <div class="brand-info">
              <div class="brand-name">Opal Garden</div>
              <div class="brand-text">Thủ Đức</div>
            </div>
