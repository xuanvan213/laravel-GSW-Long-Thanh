...
<head>
	...
	<meta charset="UTF-8" />
	 <meta name="image" content="/images/logo-ANZ.png">
	...
	<!-- Favicons -->
	<link rel="shortcut icon" sizes="196x196" href="/images/logo-ANZ.png">
	<link rel="apple-touch-icon" href="/images/logo-ANZ.png">
	<link rel="apple-touch-icon" sizes="72x72" href="/images/logo-ANZ.png">
	<link rel="apple-touch-icon" sizes="114x114" href="/images/logo-ANZ.png">
	...
	<script>
		...
		var fileInput = document.getElementById('logoProject');
		...
		//Image preview
			if (fileInput.files && fileInput.files[0]) {
				...
				reader.onload = function(e) {
					document.getElementById('imagePre').innerHTML = '<img style="width:200px;height:200px;" src="'+e.target.result+'"/>';
					};
		...
		function setImageAbout(){
			var fileInput = document.getElementById('imageAbouts');
			var filePath = fileInput.value;//lấy giá trị input theo id
			if (fileInput.files && fileInput.files[0]) {
				var reader = new FileReader();
					reader.onload = function(e) {
						document.getElementById('imgAbout').innerHTML = '<img style="width:200px;height:200px;" src="'+e.target.result+'"/>';
					};
					reader.readAsDataURL(fileInput.files[0]);
			}
		}
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
	<ul>
		...
		<li> <a href="{{ url('/admin/form')}}"><i class="icon icon-th-list"></i> <span>Thêm Dự Án</span></a></li>
